...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    window->DrawList->AddRectFilled(check_bb.Min + ImVec2(it_anim->second.animation, it_anim->second.animation), check_bb.Max - ImVec2(it_anim->second.animation, it_anim->second.animation), (ImColor)ImVec4((float)254 / 255, (float)71 / 255, (float)165 / 225, it_anim->second.opacity), 5.0f);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    window->DrawList->AddCircleFilled(total_bb.Max - ImVec2(15, 13), 7.0f, (ImColor)ImVec4((float)245 / 255, (float)40 / 255, (float)145 / 255, it_anim->second.circle), 100);
    window->DrawList->AddShadowCircle(total_bb.Max - ImVec2(15, 13), 5.f, (ImColor)ImVec4((float)245 / 255, (float)40 / 255, (float)145 / 255, it_anim->second.circle), 50.f, ImVec2(0, 0), 0, 12);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    if (grab_bb.Max.x > grab_bb.Min.x)
        ...
        window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(0, 23), frame_bb.Min + ImVec2(it_anim->second.animation, 30), ImColor(254, 71, 165), 5.0f);
...
bool ImGui::Keybind(const char* label, int* key, bool show_label)
{
    ...
    ImGui::PushStyleColor(ImGuiCol_Text, (ImU32)ImColor(255, 110, 185, 200));
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    if (render_cursor || render_selection)
    {
        ...
        if (render_selection)
        {
            ...
            ImU32 bg_color = GetColorU32(ImVec4((float)245/255, (float)40/255, (float)145/255, 0.1f), render_cursor ? 1.0f : 0.6f); // FIXME: current code flow mandate that render_cursor is always true here, we are leaving the transparent one for tests.
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
    ...
    it_anim->second.text = ImLerp(it_anim->second.text, hovered ? 0.8f : 0.4f && selected ? 0.8f : 0.4f, 0.1f * (1.0f - ImGui::GetIO().DeltaTime));
    it_anim->second.r = ImLerp(it_anim->second.r, selected ? (float)245/255 : (float)255 / 255, 0.1f * (1.0f - ImGui::GetIO().DeltaTime));
    it_anim->second.g = ImLerp(it_anim->second.g, selected ? (float)40/255 : (float)255 / 255, 0.1f * (1.0f - ImGui::GetIO().DeltaTime));
    it_anim->second.b = ImLerp(it_anim->second.b, selected ? (float)145 / 255 : (float)255 / 255, 0.1f * (1.0f - ImGui::GetIO().DeltaTime));
