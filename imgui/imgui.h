...
namespace ImGui
{
    ...
    IMGUI_API ImU32         GetColorU32(ImVec4 c, float alpha_mul);
    ...
    IMGUI_API bool          ColorButton(const char* desc_id, const ImVec4& col, ImGuiColorEditFlags flags = 0, const ImVec2& size = ImVec2(0, 0), const ImVec2& pos_arg = ImVec2(0,0)); // display a color square/button, hover for details, return true when pressed.
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddColoredText(const ImVec2& pos, ImU32 color1, ImU32 color2, const char* text);
